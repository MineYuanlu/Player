package net.raypixel.bukkit.player.commands;

import net.raypixel.bukkit.player.Messages;
import net.raypixel.bukkit.player.Permissions;
import net.raypixel.bukkit.player.events.ExperienceUpdateEvent;
	...
	private boolean isValid(String input) {
		if (StringUtils.isNumeric(input)) {
			if (input.toCharArray().length < 10) {
				...
				if (Integer.valueOf(String.valueOf(input.charAt(0))) < 2) {
					return true;
				} else if (Integer.valueOf(String.valueOf(input.charAt(0))) == 2) {
					return Integer.valueOf(String.valueOf(input.charAt(1))) <= 1 && Integer.valueOf(String.valueOf(input.charAt(2))) <= 3;
				} else {
					return false;
				}
			} else {
